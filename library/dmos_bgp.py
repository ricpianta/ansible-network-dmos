...
module: dmos_bgp
version_added: "2.8"
author: "Ricardo Pianta (@ricpianta)"
short_description: Configure global BGP protocol settings on Datacom DmOS
description:
  - This module provides configuration management of global BGP parameters
    on devices running Datacom DmOS
notes:
  - Tested against Datacom DmOS Software Version 4.6
options:
  bgp_as:
    description:
    ...
    suboptions:
      ...
      timers:
        ...
        suboptions:
          keepalive:
            description:
              - Frequency with which the Datacom DmOS software sends keepalive messages to its peer.
...
from ansible.module_utils.network.dmos.dmos import get_config, load_config
from ansible.module_utils.network.dmos.config.bgp import get_bgp_as
from ansible.module_utils.network.dmos.config.bgp.process import BgpProcess
